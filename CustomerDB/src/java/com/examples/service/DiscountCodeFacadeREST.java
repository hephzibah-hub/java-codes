...
import com.examples.DiscountCode;
 ...
 */
@javax.ejb.Stateless
@javax.ws.rs.Path("com.examples.discountcode")
public class DiscountCodeFacadeREST extends AbstractFacade<DiscountCode> {
    ...
    @javax.ws.rs.Path("{id}")
    @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@javax.ws.rs.PathParam("id") String id, DiscountCode entity) {
        super.edit(entity);
    }
    ...
    public DiscountCode find(@javax.ws.rs.PathParam("id") String id) {
    ...
    @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<DiscountCode> findRange(@javax.ws.rs.PathParam("from") Integer from, @javax.ws.rs.PathParam("to") Integer to) {
