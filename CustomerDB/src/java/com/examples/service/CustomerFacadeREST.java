 ...
 */
@javax.ejb.Stateless
@javax.ws.rs.Path("com.examples.customer")
public class CustomerFacadeREST extends AbstractFacade<Customer> {
    ...
    @javax.ws.rs.Path("{id}")
    @javax.ws.rs.Consumes({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public void edit(@javax.ws.rs.PathParam("id") Integer id, Customer entity) {
        super.edit(entity);
    }
    ...
    public Customer find(@javax.ws.rs.PathParam("id") Integer id) {
    ...
    @javax.ws.rs.Produces({javax.ws.rs.core.MediaType.APPLICATION_XML, javax.ws.rs.core.MediaType.APPLICATION_JSON})
    public List<Customer> findRange(@javax.ws.rs.PathParam("from") Integer from, @javax.ws.rs.PathParam("to") Integer to) {
